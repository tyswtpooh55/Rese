...
class ShopsTableSeeder extends Seeder
{
    ...
    $shops = [
        [
            ...
            'area_id' => 1,
            'genre_id' => 1,
            'image_path' => asset('/storage/images/sushi.jpg'),
        ...
        [
            ...
            'area_id' => 2,
            'genre_id' => 2,
            'image_path' => asset('/storage/images/yakiniku.jpg'),
        ...
        [
            ...
            'area_id' => 3,
            'genre_id' => 3,
            'image_path' => asset('/storage/images/izakaya.jpg'),
        ...
        [
            ...
            'area_id' => 1,
            'genre_id' => 4,
            'image_path' => asset('/storage/images/italian.jpg'),
        ...
        [
            ...
            'area_id' => 3,
            'genre_id' => 5,
            'image_path' => asset('/storage/images/ramen.jpg'),
